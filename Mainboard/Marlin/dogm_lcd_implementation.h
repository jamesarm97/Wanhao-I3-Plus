...
static void lcd_implementation_status_screen()
{
 ...
 static unsigned int progress_timer = 0,timepr=0,timepr2=0;
 ...
 u8g.drawPixel(50,43);*/
//SD Card Symbol	Sd 卡图标
 u8g.drawBox(5,42,8,7);		//位置坐标,大小方块
 u8g.drawBox(13,44,2,5);	//位置坐标,大小方块
 u8g.drawFrame(5,49,10,4);	//位置坐标,大小方块
 u8g.drawPixel(13,43);		//点

 // Progress bar
 u8g.drawFrame(20,44,85,6);//u8g.drawFrame(54,49,73,4);
 ...
 if (IS_SD_PRINTING)
   {
	...
	//u8g.drawBox(55,50, (unsigned int)( (71 * card.percentDone())/100) ,2);
	   u8g.drawBox(20,45, (unsigned int)( (85 * card.percentDone())/100) ,5);
   }
    else {
			// do nothing
			progress_timer=0;
...
u8g.setPrintPos(60,42);
 ...
 // Extruder 1
 u8g.setFont(FONT_STATUSMENU);
 u8g.setPrintPos(6+33,6);
 u8g.print(itostr3(int(degTargetHotend(0) + 0.5)));
 lcd_printPGM(PSTR(LCD_STR_DEGREE " "));
 u8g.setPrintPos(6+32,27);
 u8g.print(itostr3(int(degHotend(0) + 0.5)));
 lcd_printPGM(PSTR(LCD_STR_DEGREE " "));
 if (!isHeatingHotend(0)) u8g.drawBox(13+33,10,2,7);
	else
		{
		 u8g.setColorIndex(0);	// white on black
		 u8g.drawBox(13+33,10,2,7);
		 u8g.setColorIndex(1);	// black on white
		}
 ...
 */
 ...
 lcd_printPGM(PSTR(LCD_STR_DEGREE " "));
 if (!isHeatingBed()) u8g.drawBox(88-9,18,0,0);
	else
		{
		 u8g.setColorIndex(0);	// white on black
		 u8g.drawBox(88-9,18,0,0);
		 u8g.setColorIndex(1);	// black on white
		}
 
 // Fan
 u8g.setFont(FONT_STATUSMENU);
 u8g.setPrintPos(104-1,27);
